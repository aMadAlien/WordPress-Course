...
const divsToUpdate = document.querySelectorAll(".paying-attention-update-me"); // renders the block (quiz)
...
function Quiz(props) {
  ...
  const [isCorrectDelayed, setIsCorrectDelayed] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined); // if a selected answer is incorrect, wait 2.6s and refresh
  ...
  return (// style property changes the bgc and text-alignment on the frontend
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      return (// if selected incorrect answer it retrieves "no-click" class (-> happends nothing)
        (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
          className: (isCorrectDelayed === true && index == props.correctAnswer ? "no-click" : "") + ( // if selected correct answer - incorrect others retrieve "fade-incorrect" class
